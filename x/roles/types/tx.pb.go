...
func (*MsgRemove) Descriptor() ([]byte, []int) {
	return fileDescriptor_249328e0abbb05f1, []int{2}
}
...
func (*MsgRemoveResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_249328e0abbb05f1, []int{3}
}
...
func init() {
	...
	proto.RegisterType((*MsgRemove)(nil), "smplchain.roles.MsgRemove")
	proto.RegisterType((*MsgRemoveResponse)(nil), "smplchain.roles.MsgRemoveResponse")
}
...
var fileDescriptor_249328e0abbb05f1 = []byte{
	...
	,
}
...
func (c *msgClient) Remove(ctx context.Context, in *MsgRemove, opts ...grpc.CallOption) (*MsgRemoveResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/smplchain.roles.Msg/Remove", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Remove_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/smplchain.roles.Msg/Remove",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
