...
import { Module as SmplchainRoles, msgTypes as SmplchainRolesMsgTypes } from './smplchain.roles'
import { Module as SmplchainSmplchain, msgTypes as SmplchainSmplchainMsgTypes } from './smplchain.smplchain'
import { Module as SmplchainSmplusdse, msgTypes as SmplchainSmplusdseMsgTypes } from './smplchain.smplusdse'


const Client = IgniteClient.plugin([
    CosmosAuthV1Beta1, CosmosAuthzV1Beta1, CosmosBankV1Beta1, CosmosBaseTendermintV1Beta1, CosmosCrisisV1Beta1, CosmosDistributionV1Beta1, CosmosEvidenceV1Beta1, CosmosFeegrantV1Beta1, CosmosGovV1, CosmosGovV1Beta1, CosmosGroupV1, CosmosMintV1Beta1, CosmosNftV1Beta1, CosmosParamsV1Beta1, CosmosSlashingV1Beta1, CosmosStakingV1Beta1, CosmosTxV1Beta1, CosmosUpgradeV1Beta1, CosmosVestingV1Beta1, IbcApplicationsInterchainAccountsControllerV1, IbcApplicationsInterchainAccountsHostV1, IbcApplicationsTransferV1, IbcCoreChannelV1, IbcCoreClientV1, IbcCoreConnectionV1, SmplchainRoles, SmplchainSmplchain, SmplchainSmplusdse
]);
...
const registry = new Registry([
  ...
  ...SmplchainRolesMsgTypes,
  ...SmplchainSmplchainMsgTypes,
  ...SmplchainSmplusdseMsgTypes,
